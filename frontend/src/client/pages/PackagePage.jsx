...
const OffersPage = () => {
    return (
        <Box bg="white" minHeight="100vh" p={8}>
            ...
            <Grid templateColumns="repeat(2, 1fr)" gap={4} mb={12} mx={40} mt={10}>
            ...
            <Divider borderColor="gray.400" borderWidth="2px" mx={40} width="100" />
            <Grid templateColumns="repeat(2, 1fr)" gap={4} mb={12} mx={40} mt={10}>
                {/* Second Box with Image and Button Below */}
                <Box borderRadius="md" boxShadow="md" overflow="hidden">
                    <Image 
                        src={Silver}
                        alt="Box Image"
            ...
            <Divider borderColor="gray.400" borderWidth="2px" mx={40} width="100" />
            <Grid templateColumns="repeat(2, 1fr)" gap={4} mb={12} mx={40} mt={10}>
                {/* Third Box with Image and Button Below */}
                <Box borderRadius="md" boxShadow="md" overflow="hidden">
                    <Image 
                        src={Gold}
                        alt="Box Image"
            ...
            <Grid templateColumns="repeat(2, 1fr)" gap={4} mb={12} mx={40} mt={10}>
                {/* Fourth Box with Image and Button Below */}
                <Box borderRadius="md" boxShadow="md" overflow="hidden">
                    <Image 
                        src={Platinum}
                        alt="Box Image"
